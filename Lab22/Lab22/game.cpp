...
void Game::setUpGame()
{
	...
	for (int i = 0; i < 2; i++) //Place five crystals in the world
	{
		do
		{
			r = rand() % (rows - 1) + 1;
	...
	for (int i = 0; i < 1; i++) //Place five shields in the world
	{
		do
		{
			r = rand() % (rows - 1) + 1;
	...
	for (int i = 0; i < 2; i++) //Place shops in the world
	{
		do
		{
			r = rand() % (rows - 1) + 1;
	...
	for (int i = 0; i < 15; i++) //Place two monsters in the world
	{
		do
		{
			r = rand() % (rows - 1) + 1;
